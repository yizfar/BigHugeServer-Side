...
// מציג את כל רשימת המשתמשים רק לאדמין
...
// מציג רק את המידע על היוזר וכל יוזר לפי הטוקן שלו
...
// משנה משתמש רגיל לאדמין ולהפך וכל משתמש אדמין יכול לבצע 
// יוצא מן הכלל זה הסופר אדמין שנתנו את האיי די שלו שלא ניתן לשנות אותו
...
router.patch("/changeRole/:userId/:role", authAdmin, async (req, res) => {
  ...
  try {
    //61deb982d83384c7ecf3ce0d -> user of super admin that cant change to regular user moshe user
...
// TODO: Add to favs_ar route  and remove from favs_ar
